...
';
    ...
    $ph['widgets'] = $output;
    ?>
    <?php echo ManagerTheme::makeTemplate('welcome', 'manager_welcome_tpl', $ph, false); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('manager::template.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH Z:/domains/evo2.local/manager//views//page/2.blade.php ENDPATH**/ ?>